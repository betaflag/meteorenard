...
export function TimeBlockDetailDialog({ block, onClose }: TimeBlockDetailDialogProps) {
  ...
  return (
    ...
    >
      {block && (
        <DialogContent hideCloseButton className="max-w-3xl gap-8 p-8 sm:p-10">
          {/* Header */}
          <div className="flex items-start justify-between gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <DialogDescription style={{ fontSize: '1.125rem' }}>
          ...
          <div className="flex flex-wrap items-center justify-between gap-x-8 gap-y-6">
            <div className="flex items-center gap-5">
              <div style={{ color: BRASS, filter: 'drop-shadow(0 0 8px rgba(197, 165, 114, 0.6))' }}>
                <WeatherIcon condition={block.condition} size={96} />
              </div>
              <div className="flex flex-col">
                <span
                ...
                <span className="text-[#e5e7eb]" style={{ fontSize: '1.25rem' }}>
          ...
          {/* Prominent close button for kiosk touch */}
          <DialogClose asChild>
            <button
              type="button"
              className="mx-auto rounded-xl font-raleway font-semibold transition-colors"
              style={{
                padding: '15px 56px',
                fontSize: '1.125rem',
                color: ORANGE,
