...
function translateCondition(condition: string): string {
  const translations: Record<string, string> = {
    ...
    'Clear': 'Dégagé',
    'Sunny': 'Ensoleillé',
    'Mix of sun and cloud': 'Mélange de soleil et nuages',
    'Mainly sunny': 'Plutôt ensoleillé',
...
/**
 * Get French day label from forecast period name
 */
function getDayLabel(periodName: string): string {
  ...
  for (const [english, french] of Object.entries(dayMap)) {
